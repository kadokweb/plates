...
use KadokWeb\Plates\Extension\LayoutSections\{
...
use const KadokWeb\Plates\Extension\LayoutSections\{
    START_APPEND,
    START_PREPEND,
    START_REPLACE
};
use function KadokWeb\Plates\Extension\LayoutSections\{
    startFunc,
    sectionFunc
};
use function KadokWeb\Plates\Extension\RenderContext\{endFunc};
