...
namespace KadokWeb\Plates\Extension\LayoutSections;

use KadokWeb\Plates;
use KadokWeb\Plates\Template;

use KadokWeb\Plates\Extension\RenderContext\FuncArgs;
use function KadokWeb\Plates\Extension\RenderContext\startBufferFunc;
